...
export interface BasicDataInterface {
    ...
    // Lade die nächstälteren Transaktionen und Aktivitäten der Gruppe mit groupId, die seit dem letzten Login noch nicht abgefragt wurden
    // und gib sie an den entsprechenden Observable.
